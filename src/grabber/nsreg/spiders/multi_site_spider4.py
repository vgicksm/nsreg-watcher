...
class MultiSiteSpider4(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.component = BaseSpiderComponent(
            ...
            path={
                'price_reg': (
                    '/html/body/main/section[4]/div[2]/div[3]/div/div/div/div/div[1]/div/table/tbody/tr[2]/td[2]/div/p/text()'
                ),
                'price_prolong': (
                    '/html/body/main/section[4]/div[2]/div[3]/div/div/div/div/div[1]/div/table/tbody/tr[3]/td[2]/div/p/text()'
                ),
                'price_change': (
                    '/html/body/main/section[4]/div[2]/div[3]/div/div/div/div/div[1]/div/table/tbody/tr[4]/td[2]/div/p/text()'
                )
            }
        )
